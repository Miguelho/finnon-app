...
import { Mail } from "lucide-react"; // o tu icono preferido

/**
 * NotificationDropdown — Sobre con badge en el navbar
 *
 * Al hacer clic se despliega un dropdown con la actividad de otros usuarios.
 * Cada notificación tiene un CTA "Ver →" que redirige a Movimientos.
 *
 * Props:
 * - notifications: [{ id, userInitial, userName, count, timeAgo }]
 * - onView: (notificationId) => void — navega a movimientos filtrados
 */
export default function NotificationDropdown({ notifications, onView }) {
