export const es = {
  ...
  projects: {
    ...
    monthClose: {
      ...
      surplusToHucha: "Enviar excedente a la Hucha",
  ...
  home: {
    ...
    dotsLegend: "Verde ingresos · Rojo gastos · Amarillo pendiente",
  ...
  mobile: {
    ...
    home: {
      ...
      calendarWeek: "Semana",
      calendarMonth: "Mes",
      calendarIncome: "Ingresos",
      calendarExpenses: "Gastos",
      calendarNet: "Neto",
