export const es = {
  ...
  transactions: {
    ...
    ui: {
      ...
      summaryConfirmedOne: "confirmado",
      summaryConfirmedOther: "confirmados",
      summaryEmpty: "Sin movimientos en este periodo",
      summaryLegendButton: "Mostrar leyenda de colores",
      summaryLegendSolid: "Color sólido = confirmado",
  ...
  projects: {
    ...
    monthClose: {
      ...
      pendingDescription: "Aún no has confirmado el reparto de {month}.",
      ...
      alreadyConfirmed: "Este cierre ya fue confirmado.",
      ...
      confirmed: "Reparto confirmado y guardado en el historial.",
    },
  },
  categories: {
    title: "Categorías",
